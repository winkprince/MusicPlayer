...
public class MeActivity extends AppCompatActivity {
    ...
    private MusicAdapter mMusicAdapter1;
    ...
    private void initEvent(){
         mMusicAdapter1 = new MusicAdapter(this, musicList);
        musicListView = findViewById(R.id.meListView);
        musicListView.setAdapter(mMusicAdapter1);
        musicListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MeActivity.this,MusicPlayerActivity.class);
