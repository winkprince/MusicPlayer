...
public class AnimationStart extends AppCompatActivity implements View.OnClickListener  {

    private int recLen = 6;//跳过倒计时提示5秒
    private TextView tv,textView3,textView4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       timer.schedule(task, 1000, 1000);//等待时间一秒，停顿时间一秒
        ...
        handler.postDelayed(runnable = new Runnable() {
            ...
            public void run() {
                //从闪屏界面跳转到首界面
                Intent intent = new Intent(AnimationStart.this, LoginActivity.class);
                startActivity(intent);
                finish();
            }
        }, 7000);//延迟5S后发送handler信息
    }
